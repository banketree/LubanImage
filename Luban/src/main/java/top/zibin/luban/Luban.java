...
public class Luban implements Handler.Callback {
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                try {
                    ...
                    File result = new Engine(file, getImageCacheFile(context)).compress(zoom);
    ...
    private File get(final Context context) throws IOException {
        return new Engine(file, getImageCacheFile(context)).compress(zoom);
    }
    ...
    public static class Builder {
        ...
        public Builder putZoom(float zoom) {
            this.zoom = zoom;
            return this;
        }
